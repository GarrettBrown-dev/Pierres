...
namespace PT.Controllers
{
    ...
    public class FlavorsController : Controller
    {
        ...
        public FlavorsController(UserManager<ApplicationUser> userManager, PTContext db)
        {
        ...
        public async Task<ActionResult> Search(string search)
        {
            ...
            var userTreats = _db.Treats.Where(entry => entry.User.Id == thisCurrentUser.Id);
            var searchedUserRecipes = userTreats.Where(treat => (treat.TreatName.Contains(search))).ToList();
